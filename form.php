...
$myForm->addFields('email', 'email', 'Email...', ['required'=>'required', 'class'=>'form-control']);
$myForm->addFields('password', 'password', 'Password...', ['required'=>'required', 'class'=>'form-control']);
$myForm->submitButton('submit', 'Invia', ['class'=>'btn btn-dark']);
